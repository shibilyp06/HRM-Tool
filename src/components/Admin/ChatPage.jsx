      ...
      <div className="flex flex-col items-center justify-center w-screen min-h-screen bg-gray-100 text-gray-800 p-10">
        <div className="flex flex-col flex-grow w-full max-w-xl bg-white shadow-xl rounded-lg overflow-hidden">
          <div className="flex w-screen bg-blue-400 h-16 gap-3" >
            ...
            <button className="flex justify-center items-center duration-700  hover:rounded-3xl rounded-sm w-20 hover:bg-slate-500 hover:text-white  bg-slate-200" onClick={()=>{
              window.history.back()
            }}>
            <div className="">
              <svg
            ...
            <div className=" flex flex-col justify-center items-center">
              ...
              <p className="text-sm text-gray-100 font-semibold">{profile.position}</p>
